              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  <div class="title-box-2">
                    <h5 class="title-left">
                      About Us:
                      <h2>Our team of experienced professionals brings a wealth of expertise to every event, ensuring seamless execution from inception to the last dance. From intimate gatherings to lavish affairs,
                ...
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico">
                      ...
                      <li><span class="ion-email"></span>shubh19@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright"> <strong>shubh mangal Wedding Planner</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
