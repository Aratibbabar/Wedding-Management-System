...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Shubh Managal Wedding Planner</a>
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  <div class="title-box-2">
                    <h5 class="title-left">
                      About Us:
                      Our team of experienced professionals brings a wealth of expertise to every event,ensuring seamless execution from inception to the last dance. From intimate gatherings to lavish affairs,
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright"> <strong>shubh mangal Wedding Planne</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
