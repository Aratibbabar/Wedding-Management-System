...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">shubh mangal Wedding Planner</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">shubh mangal Wedding Planner</h1>
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  <div class="title-box-2">
                    <h5 class="title-left">
                      About us:Our team of experienced professionals brings a wealth of expertise to every event, ensuring seamless execution from inception to the last dance. From intimate gatherings to lavish affairs,
 we specialize in curating bespoke experiences tailored to our clients visions, preferences, and personalities.
            ...
            <div id="contact" class="box-shadow-full">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    <p class="lead">
                    Surya nagar new hudko colony

                     </p>
                    <ul class="list-ico">
                      <li><span class="ion-ios-location"></span>582101-Surya nagar new hudko colony</li>
                      <li><span class="ion-ios-telephone"></span> +919608472701</li>
                      <li><span class="ion-email"></span> Shubh 19@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>Shubh Mangal Wedding Planner</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
                ...
                -->
                Designed by <a href="#">Arati B and Aatera M</a>
              </div>
            </div>
          </div>
        </div>
